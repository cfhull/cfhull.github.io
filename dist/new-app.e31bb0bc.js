...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../.npm/_npx/25233/lib/node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../.npm/_npx/25233/lib/node_modules/parcel/src/builtins/css-loader.js":[function(require,module,exports) {
...
var _data = _interopRequireDefault(require("./data.csv"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

var createSkillsChart = function createSkillsChart() {
  var margin = {
    top: 20,
    right: 0,
    bottom: 0,
  ...
  var barPadding = 5;
  var svg = d3.select('#skillChart').append('svg').attr('width', '100%').attr('height', svgHeight + margin.top + margin.bottom);
  var bars = svg.append('g');
  var xLabels = svg.append('g').attr('class', 'xLabel');
  var yLabels = svg.append('g').attr('class', 'yLabel');
  var barEvents = svg.append('g');
  svg.append('svg:defs');
  ...
  gradientColors.forEach(function (gradientColor, i) {
    var gradient = svg.select('defs').append('svg:linearGradient').attr('id', 'gradient' + i).attr('x1', '0%').attr('y1', '50%').attr('x2', '100%').attr('y2', '50%').attr('spreadMethod', 'pad');
    gradient.append('svg:stop').attr('offset', '0%').attr('stop-color', gradientColor[0]).attr('stop-opacity', 1);
    gradient.append('svg:stop').attr('offset', '100%').attr('stop-color', gradientColor[1]).attr('stop-opacity', 1);
  });
  d3.csv(_data.default, type).then(function (data) {
  ...
  function render(data) {
    var svgWidth = d3.select('#skillChart').node().parentElement.clientWidth;
    var xScale = d3.scaleLinear().domain([0, 5]).range([0, svgWidth - 20]);
    var yScale = d3.scaleBand().domain(data.map(function (d) {
      return d.name;
    })).range([0, svgHeight]);
    bars.selectAll('rect').data(data).join(function (enter) {
      return enter.append('rect').style('fill', function (d, i) {
        return 'url(#gradient' + i % gradientColors.length + ')';
      }).attr('class', 'bar').attr('width', function (d) {
        return xScale(d.value);
      }).attr('height', svgHeight / data.length - barPadding).attr('y', function (d) {
        return yScale(d.name);
      });
    }, function (update) {
      return update.attr('width', function (d) {
        return xScale(d.value);
      });
    });
    xLabels.selectAll('text').data(data).join(function (enter) {
      return enter.append('text').text(function (d) {
        return d.value;
      }).attr('x', function (d) {
        return xScale(d.value) + 5;
      }).attr('y', function (d, i) {
        return i * (svgHeight / data.length) + (svgHeight / data.length - barPadding) / 2;
    ...
    yLabels.selectAll('text').data(data).join(function (enter) {
      return enter.append('text').text(function (d) {
        return d.name;
      }).attr('x', 5).attr('y', function (d, i) {
        return i * (svgHeight / data.length) + (svgHeight / data.length - barPadding) / 2;
      }).attr('fill', 'white').attr('alignment-baseline', 'central');
    });
    barEvents.selectAll('rect').data(data).join(function (enter) {
      return enter.append('rect').style('fill', 'white').style('fill-opacity', '0.0').attr('class', 'barEvent').attr('height', svgHeight / data.length - barPadding).attr('width', function (d) {
        return xScale(d.value);
      }).attr('y', function (d) {
        return yScale(d.name);
      }).on('click', function (d) {
        ...
        return d3.select(d3.event.currentTarget).style('stroke', 'black');
      }).on('mouseout', function () {
        return d3.select(d3.event.currentTarget).style('stroke', 'none');
      });
    }, function (update) {
      return update.attr('width', function (d) {
        return xScale(d.value);
  ...
  function selectBar(selectedBar) {
    barEvents.selectAll('rect').style('stroke', 'none').style('fill-opacity', '0.0');
    selectedBar.style('stroke', 'black').style('fill-opacity', '0.5');
...
var _default = createSkillsChart;
exports.default = _default;
},{"d3":"node_modules/d3/index.js","./data.csv":"data.csv"}],"index.js":[function(require,module,exports) {
"use strict";

require("@fortawesome/fontawesome-free/css/all.css");

var _skillsChart = _interopRequireDefault(require("./skillsChart.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _skillsChart.default)();
},{"@fortawesome/fontawesome-free/css/all.css":"node_modules/@fortawesome/fontawesome-free/css/all.css","./skillsChart.js":"skillsChart.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39877" + '/');
...
//# sourceMappingURL=/new-app.e31bb0bc.js.map